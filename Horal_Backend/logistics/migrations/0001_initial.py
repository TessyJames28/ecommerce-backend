    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_measurement', models.CharField(choices=[('standard', 'Standard Size (e.g. S, M, L)'), ('INCH', 'Inch'), ('CM', 'Centimeter'), ('KG', 'Kilogram'), ('G', 'Gram'), ('ML', 'Milliliter'), ('L', 'Liter'), ('OZ', 'Ounces'), ('LB', 'Pounds'), ('M', 'Meters'), ('FT', 'Feet')], max_length=10)),
