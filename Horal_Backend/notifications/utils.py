...
ALLOWED_NOTIFICATION_MODELS = {
    "order": apps.get_model("orders", "Order"),
    "support": apps.get_model("support", "Message"),
    "ticket": apps.get_model("support", "Tickets"),
    "return": apps.get_model("orders", "OrderReturnRequest"),
    "sellerkyc": apps.get_model("sellers", "SellerKYC"),
